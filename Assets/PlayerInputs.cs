...
public partial class @PlayerInputs: IInputActionCollection2, IDisposable
{
    ...
    ~@PlayerInputs()
    {
        Debug.Assert(!m_PlayerControls.enabled, "This will cause a leak and performance issues, PlayerInputs.PlayerControls.Disable() has not been called.");
        Debug.Assert(!m_Newactionmap.enabled, "This will cause a leak and performance issues, PlayerInputs.Newactionmap.Disable() has not been called.");
    }
